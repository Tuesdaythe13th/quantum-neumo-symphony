...
const PythonCodeDisplay: React.FC<PythonCodeDisplayProps> = ({ className }) => {
  return (
    <div className={cn("mt-8 p-4 bg-gray-900 text-gray-300 rounded-lg font-mono text-xs overflow-auto", className)}>
      <h3 className="text-purple-400 font-semibold mb-3">QPIXL Helper Functions:</h3>
...
def convertToGrayscale(a,maxval=1):
    ...
    return a`}
      ...
      <h3 className="text-purple-400 font-semibold mt-6 mb-3">Additional Helper Functions:</h3>
      <pre className="overflow-x-auto whitespace-pre-wrap">
